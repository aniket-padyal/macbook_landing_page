  ...
  return (
    <div
      ...
      style={{
        ...
        background: `
    radial-gradient(800px circle at 50% 50%, #f8e2d7 0%, transparent 60%),
    radial-gradient(1100px circle at 30% 30%, #b8a0ff 0%, transparent 70%),
    radial-gradient(1200px circle at 80% 20%, #3b65ff 0%, transparent 80%),
    radial-gradient(900px circle at 70% 75%, #ff9fb3 0%, transparent 75%),
    linear-gradient(135deg, #2e41eb, #2f1db7)
  `,
      }}
    >
      <svg
